...
const SignUp = () => {
    ...
    return (
            <div className='h-[800px] my-20 flex justify-center items-center'>
                <div className='w-96 p-7 border rounded-2xl shadow-xl'>
                    <h1 className="text-4xl mb-6 text-center font-bold">Sign Up!</h1>
                    <form onSubmit={handleSubmit(handleSignUp)}>
                        ...
                        <div className="form-control w-full">
                            ...
                            <input type="file" className=" w-full max-w-xs mb-4" accept='image/*' required
                                {...register("img",
                                    {
